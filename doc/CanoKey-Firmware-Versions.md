...
The version set matches `canokey-usbip` commit `70c9572f599b0afd468dd87978a375d8fa325928`, `compat/config/firmwares.yaml`. Intermediate firmware changes are folded into the next cataloged snapshot.
