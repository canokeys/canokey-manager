...
The version set matches `canokey-usbip` commit `f7d8fe3df32dddc119cfdbfbcae53e1e69556c38`, `compat/config/firmwares.yaml`. Intermediate firmware changes are folded into the next cataloged snapshot.
